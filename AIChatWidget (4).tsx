...
const AIChatWidget: React.FC<{ products: Product[] }> = ({ products }) => {
  ...
  // Gemini Initialization - Skill mandates using process.env.GEMINI_API_KEY in Vite with define
  ...
  const handleSend = async (e?: React.FormEvent) => {
    ...
    try {
      // 2. Prepare History for Gemini (Filtered history + current message)
      ...
      // 3. Call Gemini Directly (Skill Guideline)
      ...
      const botText = response.text || "Maaf Kak, aku bingung jawabnya. Coba tanya lagi ya!";
