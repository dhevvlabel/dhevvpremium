        ...
        <div className="relative z-10 w-full max-w-3xl mt-12 mb-20">
          ...
          <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-8 md:p-12 shadow-2xl text-center">
            <p className="text-stone-300 leading-relaxed text-lg md:text-xl font-light">
              Dhevv Premium adalah platform penyedia layanan lisensi aplikasi premium dan jasa kreatif digital yang berbasis di Bandung. Berawal dari semangat untuk mempermudah akses hiburan dan produktivitas berkualitas dengan harga yang terjangkau bagi semua kalangan. Kami berkomitmen memberikan pelayanan yang instan, aman, dan bergaransi demi kepuasan pelanggan di seluruh Indonesia.
            </p>
